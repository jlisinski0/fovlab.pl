	...
	return (
		<section className='h-auto bg-pearl_perfect' id='uslugi'>
			<div className='flex flex-col  h-full w-full max-w-7xl mx-auto px-10 py-20' data-aos='fade-up' data-aos-duration='500'>
				<div className='flex gap-2 text-[11px] text-black/80 uppercase tracking-[.12em] mb-4 before:content-["<"] before:mr-2 before:opacity-50 after:content-[">"] after:ml-2 after:opacity-50'>
					Usługi
				</div>
				<div className='flex flex-col gap-5 md:flex-row md:justify-between'>
					...
					<p className='flex items-center text-black/60 max-w-100'>
