		...
		<section className='h-auto bg-midnightTwo py-15'>
			<div className='flex flex-col h-full w-full max-w-7xl mx-auto px-10 py-20' data-aos='fade-up' data-aos-duration='500'>
				...
				<p className='text-base lg:text-lg max-w-250 text-white/80 pt-10'>
					Nie wierzę w <strong>masowe szablony i powtarzalne schematy</strong>, które gubią się w tłumie. Łącze <strong>ultraszybkie strony WWW</strong>, <strong>inteligentny e-commerce</strong>{' '}
					oraz <strong>dedykowane chatboty AI</strong>{' '}
