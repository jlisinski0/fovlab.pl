...
export default function NavMobile({ state }: { state: (val: boolean) => void }) {
	return (
		<motion.div
			...
			className='h-auto sticky top-18  w-full bg-pearl_perfect z-50 lg:hidden pb-10 px-10'>
			<div className='flex flex-col items-start  h-full w-full z-10 border-b border-grey/50'>
