...
import { serviceCheckItem } from '@/src/types'
import { slugItem } from '@/src/types'
...
export const serviceCheckItems: serviceCheckItem[] = [
	{
		id: 1,
...
export const ServiceHeaderItems: ServiceHeaderItem[] = [
	{
		id: 1,
		slug: 'strony-internetowe',
...
export const ServiceWhyUsItems: ServiceWhyUsItem[] = [
	{
		id: 1,
		slug: 'strony-internetowe',
...
export const ServiceManifestoItems: ServiceManifestoItem[] = [
	{
		id: 1,
		slug: 'strony-internetowe',
		title: (
...
export const ServiceProsConsItems = {
	'strony-internetowe': [
		{
			id: 1,
	...
	'sklepy-internetowe': [
		{
			id: 1,
			heading: 'Przeładowane systemy i porzucone koszyki.',
			btnText: 'Stare podejście',
			features: [
				'Sklep postawiony na WooCommerce lub masowym szablonie, który zacina się przy większym ruchu.',
				'Skomplikowana i powolna ścieżka zakupowa (checkout), przez którą klienci uciekają przed płatnością.',
				'Brak elastyczności — każda nowa funkcja wymaga kolejnej wtyczki, która dodatkowo spowalnia system.',
				'Uzależnienie od zewnętrznych platform, abonamentów lub ukrytych prowizji od Twojej własnej sprzedaży.',
			],
		},
		{
			id: 2,
			heading: 'Nowoczesny E-commerce w architekturze Headless',
	...
	'chatboty-ai': [
		{
			id: 1,
			heading: 'Sztywne, irytujące i bezużyteczne skrypty.',
			btnText: 'Stare podejście',
			features: [
				'Tradycyjne boty oparte na schematach (drzewkach decyzji), które nie rozumieją prostych pytań klientów.',
				'Brak integracji z wiedzą o firmie — bot odpowiada ogólnikami, frustrując osobę po drugiej stronie ekranu.',
				'Skomplikowane i toporne wdrożenie jako "obce ciało" na stronie, które spowalnia jej działanie.',
				'Ograniczenie do jednego kanału i brak realnego przełożenia na pozyskiwanie nowych klientów (leadów).',
			],
		},
		{
			id: 2,
			heading: 'Inteligentni asystenci AI zintegrowani z ekosystemem',
			btnText: 'Moje podejście',
			features: [
				'Zaawansowane chatboty AI oparte na modelach LLM, które rozmawiają naturalnie, jak żywy konsultant.',
				'Dedykowana baza wiedzy — bot jest wyszkolony wyłącznie na Twoich plikach, regulaminach i ofercie firmowej.',
				'Pełna automatyzacja i natywne wdrożenie w kod Next.js, co gwarantuje zerowy wpływ na prędkość strony.',
				'Wielokanałowość i realna konwersja — asystent działa 24/7 na WWW, WhatsAppie czy Messengerze, aktywnie domykając sprzedaż.',
			],
		},
	],
}
