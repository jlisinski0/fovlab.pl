import ServiceHeaderText from './ServiceHeaderText'
import ServiceHeaderPhoto from './ServiceHeaderPhoto'
import { ServiceHeaderItem } from '@/src/types'

export default function UslugiHeader(item: ServiceHeaderItem) {
	const { offer } = item

	return (
		<>
			<header className='relative h-auto overflow-hidden bg-midnightTwo pt-20 pb-40'>
				...
				<div className=' h-full w-full max-w-7xl mx-auto px-10 '>
					<div className='flex justify-between'>
						<ServiceHeaderText {...item} />
						<ServiceHeaderPhoto {...item} />
					</div>
				</div>
			</header>
			<div className='bg-midnightTwo/99 border border-y-whiteTwo'>
				<div className='flex justify-center w-full py-25'>
